...
class CustomQwen2_5_VLVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        dycoke_l=3,
        dycoke_p=0.8,
        dycoke_num_tokens_per_frame=360,
        dycoke_k=0.3,
        image_token_start_index=14,
        **kwargs,
    ):
        ...
        # DyCoke parameters
        self.dycoke = dycoke
        self.dycoke_l = dycoke_l
        self.dycoke_p = dycoke_p
        self.dycoke_num_tokens_per_frame = dycoke_num_tokens_per_frame
        self.dycoke_k = dycoke_k
        self.image_token_start_index = image_token_start_index


class CustomQwen2_5_VLTextConfig(PretrainedConfig):
    r"""
...
class CustomQwen2_5_VLConfig(PretrainedConfig):
    r"""
    ...
    model_type = "custom_qwen2_5_vl"
    sub_configs = {"vision_config": CustomQwen2_5_VLVisionConfig, "text_config": CustomQwen2_5_VLTextConfig}
    keys_to_ignore_at_inference = ["past_key_values"]
...
__all__ = ["CustomQwen2_5_VLConfig", "CustomQwen2_5_VLTextConfig"]
